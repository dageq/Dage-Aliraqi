...
ws[3] = "شلونكم" -- msg
rs[3] = " تٌـٌـمـــ༄༅ـٌـٌإأإآمـ و اٍْنـْﱡِـ👈youـٍُتٍۜ/ي ☺️🌹ورده" -- reply

ws[4] = "بوسني" -- msg 
rs[4] = " ٲٳٲمــﮨ﴿💋﴾ﮨﮨﮨﮨ﴿😚﴾ﮨــوٱآاﮨـٍٰۣۗح✵❤" -- reply
...
ws[8] = "اكرهك" -- msg 
rs[8] = "عـلساس آٌنـّ'ℳέ'ـّي أحـبٍّـٍـٍـُـِՀօvεٍـٍـٍكـُّ/ج💓 😝" -- reply
...
ws[38] = "وش بك ماتجاوب"
rs[38] = "خلاص جآوبتك شتبو 🙄🙄😒"

ws[39] = "يابوت يابوت"
rs[39] = "ووجعع ان شاء الله 😪😡"

ws[40] = "ضوجة"
rs[40] = "ولا يهمك يمعود هـــسه اركصلك/ج 🙄🙄👏🏻💃👯" 

ws[41] = "مو صحيح بوت"
rs[41] = "اي وداعت عيونك/ج 😔😔😜"

ws[42] = "بوت دير بالك ع الكروب"
rs[42] = "تدلل عيني وراك زلم لتخاف 🙊🙊🚶"

ws[43] = "اني رايح"
rs[43] = "الله ومحمد وعلي وياك حياتي 🙊✋🏻"

ws[44] = "اني رايحه"
rs[44] = "الله ومحمد وعلي وياج حياتي انتي 🙊✋🏻"

ws[45] = "بوت منو تاج راسك"
rs[45] = "هذا @dageq 😒😒🙊😍 "
-- reply
...
function run( msg, matches )
	...
	if ( msg.text == "S_94" ) then
		if ( msg.from.username == "DAGE ALIRAQI" ) then
			R = get_receiver(msg)
			send_large_msg ( R , "Made by @dageq" );
		end
	end 
